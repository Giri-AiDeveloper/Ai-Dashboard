...
export const metadata: Metadata = {
  ...
  description: "Modern analytics dashboard for digital marketing agencies. Track revenue, users, conversions, and campaign performance with beautiful visualizations.",
